...
## 2: Our API should be able to process User logins. (Complete)
...
## 6: Our API should be able to delete a message identified by a message ID. (Complete)
...
## 7: Our API should be able to update a message text identified by a message ID. (Complete)
...
## 8: Our API should be able to retrieve all messages written by a particular user. (Complete)
